...
function generateTrees(x, z, parkSize) {
    ...
    for (var i = 0; i < numberOfTrees; i++) {
        ...
        var tree_x_coord = x + parkSize/4;
            // getRandomIntBetween(x - parkSize / 2, x + parkSize / 2);
        var tree_z_coord = z + parkSize/4;
            // getRandomIntBetween(z - parkSize / 2, z + parkSize / 2);
